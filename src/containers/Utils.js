export { confirmModalDialog } from '../components/utils/reactConfirmModalDialog'
export { default as ReactConfirmModalDialog } from '../components/utils/reactConfirmModalDialog'
